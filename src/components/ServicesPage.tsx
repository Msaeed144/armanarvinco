    ...
    <div className="flex justify-center mb-40 mt-12">
        <div className="lg:flex gap-16">
                ...
                <div className="my-4">
                    ...
                    <Link href="/services/consulting-troubleshooting" className=" block w-fit border border-primary px-12 text-primary hover:bg-primary hover:text-white transition-all ease-in 200 duration-200 py-1 rounded-xl">مشاهده</Link>
                </div>
            </div>
    </div>
